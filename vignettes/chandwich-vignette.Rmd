...
We produce a plot akin Figure 4(c) of @CB2007, but including an extra 95\% confidence region for the vertical adjustment.
...
plot(gev_none, gev_cholesky, gev_vertical, gev_spectral)
```
